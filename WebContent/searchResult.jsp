							...
							<nav class="wsmenu slideLeft clearfix">
								<ul class="mobile-sub wsmenu-list">
									...
									<li><span class="wsmenu-click"></span> <a
										href="Album.do?op=altype&tId=1">人像</a></li>
									<li><span class="wsmenu-click"></span> <a
										href="Album.do?op=altype&tId=2">生活</a></li>
									<li><span class="wsmenu-click"></span> <a
										href="Album.do?op=altype&tId=3">动物</a></li>
									<li><span class="wsmenu-click"></span> <a
										href="Album.do?op=altype&tId=4">建筑</a></li>
									<li><span class="wsmenu-click"></span> <a
										href="Album.do?op=altype&tId=5">风景</a></li>
									<li><span class="wsmenu-click"></span> <a
										href="Album.do?op=altype&tId=6">运动</a></li>
									<li><span class="wsmenu-click"></span> <a href="">全部 <span
											class="arrow"></span>
									</a>
										...
										<form class="navbar-form" role="search"
											...
											<div class="form-group">
												<input type="text" class="form-control" placeholder="搜索相册"
													name="photolike" id="aa"
													value="${requestScope.likew==null?'':requestScope.likew}">
											</div>
				...
				<div class="wrap wrap_gray pt20">
								...
								<c:forEach var="q" items="${requestScope.lista }">
									<div class="col-sm-3">
										<div class="thumbnail thumbnail_small">
											<a href="ai.do?op=albumIndex&aId=${q.aId}" class="thumbnail__link"> <img src="${q.pUrl}"
												height="153" width="270" alt="News">
											</a>
											<div class="caption thumbnail__caption">
												...
												<div class="posted">
													...
													<ul class="posted__icon">
														<li><span> <i class="icon-comment-empty"></i>${q.co}
														</span></li>
														<li><span> <i>点赞</i>${q.aLikes}
														</span></li>
													</ul>
												</div>
											</div>
					...
					<nav aria-label="Page navigation" class="text-center">
						<ul class="pagination ">
							...
							<c:forEach begin="1" end="${requestScope.pa.totalPage}"
								var="index">
