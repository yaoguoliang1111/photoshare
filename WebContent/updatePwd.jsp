...
<body>
	...
	<div class="row" style="margin-top: 80px">
		...
		<div class="eightcol last">
			...
			<form id="my-form" action="us.do" method="post">
				...
				<div>
					<label>原密码:</label><input class="form-control " id="pass0"
						name="oldpwd" type="password" style="width: 200px" value="" required="required"/>
				</div>
				...
				<br>
				<div>
					<label>新密码:</label><input class="form-control " id="pass1"
						name="newpwd" type="password" style="width: 200px" required="required"/>
				</div>
				
				<div id="msg1" style="color: red"></div>
				<br>
				<div>
					<label>确认密码:</label><input class="form-control " id="pass2"
						name="confirmpwd" type="password" style="width: 200px" required="required" />
				</div>
				...
				<div>
					...
					<a href="userInfo.jsp" role="button"
	...
	$(function(){
		...
		$("#pass0").blur(function(){
			...
			// 作Ajax请求
			$.get("updatePwd.do?op=oldpwd","oldpwd="+$(this).val()+"&random="+Math.random(),function(data,status){
		...
		$("#pass1").blur(function(){
			...
			// 作Ajax请求
			$.get("updatePwd.do?op=newpwd","newpwd="+$(this).val()+"&random="+Math.random(),function(data,status){
		...
		$("#pass2").blur(function(){
			...
			// 作Ajax请求
			$.get("updatePwd.do?op=comfirmpwd","confirmpwd="+$(this).val()+"&random="+Math.random()+"&newpwd="+$("#pass1").val(),function(data,status){
